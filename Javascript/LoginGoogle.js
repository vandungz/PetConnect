...
const CLIENT_ID = "370070666207-5djtnr409mhau140tddj76hg5t5tbok8.apps.googleusercontent.com";
const LINK_GET_TOKEN = `https://accounts.google.com/o/oauth2/v2/auth?scope=https://www.googleapis.com/auth/userinfo.email%20https://www.googleapis.com/auth/userinfo.profile&response_type=token&redirect_uri=https%3A//oauth2.example.com/code&client_id=${CLIENT_ID}`.replace(/\s+/g, '');
/* replace(/\s+/g, '') : xoá toàn bộ hàng và khoảng trắng thừa */

/* gọi đăng nhập khi người dùng click vào button */
document.addEventListener("DOMContentLoaded", () =>{
    const sign_btn = document.querySelector(".btnGoogle");
